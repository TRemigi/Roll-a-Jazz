...
const EditCardForm = ({ card, setIsEdit }) => {
    ...
    const [formState, setFormState] = useState({  companyName: card.companyName, tagline: card.tagline, name: card.name, jobTitle: card.jobTitle, website: card.website, phone: card.phone, email: card.email});
